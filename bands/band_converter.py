...
CDMA_Bands_csv = open('data/CDMA_arfcn.csv').readlines()
UMTS_Bands_csv = open('data/UMTS_arfcn.csv').readlines()
LTE_Bands_csv = open('data/LTE_arfcn.csv').readlines()

q = open('data/CDMA_arfcn.csv').readlines()
